...
export const Icon = {
  ...
  Flag: make(<path d="M4 14V2.5M4 3h7l-1.5 2.5L11 8H4" />),
  Search: make(
    <>
  ...
  Pencil: make(
    <>
      ...
      <path d="M8.4 4.3 3 9.7l-.6 3.4 3.4-.6 5.4-5.4-2.8-2.8z" />
    </>
  ),
  Pin2: make(
    <>
      <path d="M6.5 2h3l-.4 3.2 1.8 1.9v.9H5.1v-.9l1.8-1.9L6.5 2z" />
      <path d="M8 8v5.5" />
    </>
  ),
  Map: make(
    <>
      <path d="M8 14s4.2-3.6 4.2-6.4A4.2 4.2 0 0 0 8 3.4a4.2 4.2 0 0 0-4.2 4.2C3.8 10.4 8 14 8 14z" />
