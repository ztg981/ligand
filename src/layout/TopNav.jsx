  ...
  return (
    <>
      ...
      >
        ...
        {/* Mute dot — a tiny switch for UI sound effects only (timer chimes and
           alarms bypass it by design). It lives INSIDE the topbar, hanging just
           below its bottom edge near the avatar, so it travels with the sticky
           bar instead of floating over whatever you've scrolled underneath it.
           Desktop only: phones have system volume, and the bar is too tight. */}
        <button
